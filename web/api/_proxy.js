...
const DASHBOARD_ROUTE_RULES = [
  { methods: ['GET'], pattern: /^(branches|staff|services|services\/kpi_groups|reports|reports\/data|widget\/sync_status|widget\/summary|widget\/revenue_daily|widget\/top_services|widget\/extra_services|widget\/plan_fact|plan\/settings|plan\/reviews_fact|plan\/opz_fact|bundle)$/ },
  { methods: ['GET', 'PUT'], pattern: /^metric-visibility$/ },
  { methods: ['POST'], pattern: /^(services\/kpi_groups|plan\/settings|plan\/reviews_fact|plan\/opz_fact)$/ },
